 ...
 */
final class Version20251222011523 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE purchase_request CHANGE requester_id requester_id INT NOT NULL');
        $this->addSql('ALTER TABLE purchase_request ADD CONSTRAINT FK_204D45E69280211 FOREIGN KEY (requester_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_204D45E69280211 ON purchase_request (requester_id)');
    }
